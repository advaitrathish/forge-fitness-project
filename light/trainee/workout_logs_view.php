<?php
   ...
   $Log_Id=$_SESSION['SESS_TRAINEE_ID'];
    ...
    // Filter by specific member name if requested
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <div class="pull-right">
                                <a href="workout_add.php" class="btn btn-primary btn-sm">Add New Log</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card card-box">
                                <div class="card-body">
                                    <form method="GET" action="" class="form-inline">
                                        ...
                                        <?php if($filter_mem != '') { ?>
                                            <a href="workout_logs_view.php" class="btn btn-default mb-2">Clear Filter</a>
                                        <?php } ?>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-box">
                                <div class="card-head"><header>Daily Exercise Volume (Multi-Color Bar)</header></div>
                                <div class="card-body">
