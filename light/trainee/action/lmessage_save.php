...
$tm = date( 'h:i:s A', time () );
	...
	$sql = "insert into lawyermessage(tname,sname,subjt,desp,photo,file1,date,tm)values('$tname','$sname','$subjt','$desp','$photo','$file1','$date','$tm')";
	$q1 = $db->prepare($sql);
	$q1->execute();	


	header("location:../mlawyer_send.php");
?>
