				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="row">
							<?php
								$result = $db->prepare("select * from complaints");
								$result->execute();
										...
										<div class="card-body no-padding ">
											<div class="doctor-profile">
												...
												<div class="profile-usertitle">
													<div class="doctor-name"><?php echo $rows["name"];?></div>
													<div class="name-center"> <?php echo $rows["date"];?> </div>
												</div>
												...
												<div class="profile-userbuttons">
													<a href="compalint_viewl_more.php<?php echo '?msg_id='.$rows['msg_id'];?>"
