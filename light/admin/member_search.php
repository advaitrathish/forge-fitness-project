                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-6">
                                                        <div class="btn-group">
                                                            <a href="member_register.php" id="addRow" class="btn btn-primary">
                                                ...
                                                <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="example4">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td>
                                                                <a href="member_edit.php?id=<?php echo $rows['id'];?>" class="tblEditBtn">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <a class="tblDelBtn" href="action/member_remove.php?id=<?php echo $rows['id'];?>" onclick="return confirm('Are you sure you want to delete this member?')">
                                                    ...
                                                    <div class="card-body no-padding ">
                                                        <div class="doctor-profile">
                                                            ...
                                                            <div class="profile-userbuttons">
                                                                <a href="member_edit.php?id=<?php echo $rows['id'];?>" class="btn btn-circle deepPink-bgcolor btn-sm">View Profile</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
