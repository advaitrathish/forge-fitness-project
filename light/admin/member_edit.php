<?php
    ...
    $result = $db->prepare("SELECT * FROM members WHERE id = :id");
    ...
    $stat = $row["stat"];
    $dist = $row["dist"];
    $membership_plan = $row["membership_plan"]; // Updated field
    $cntno1 = $row["cntno1"];
    $cntno2 = $row["cntno2"];
    $email = $row["email"];
    $jdate = $row["jdate"];
                            ...
                            <div class="profile-content">
                                <div class="row">
                                    <div class="card">
                                        ...
                                        <div class="white-box">
                                            <form class="edit-profile m-b30" method="post" action="action/member_update.php" enctype="multipart/form-data" autocomplete="off">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="ml-auto">
                                                    ...
                                                    <div class="col-12 m-t20">
                                                        <div class="ml-auto m-b5">
                                                            <h3>2. Membership & Contact Info</h3>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-sm-12 col-xs-12">
                                                        ...
                                                        <select name="membership_plan" class="form-control" required>
                                                            <option value="<?php echo $membership_plan;?>" selected><?php echo $membership_plan;?></option>
                                                    ...
                                                    <div class="col-12">
                                                        <button type="submit" class="btn pull-right btn-primary">Update Member</button>
                                                    </div>
                                                </div>
                                            </form>     
                                            </div>
